...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Sequential(
                WTConv2d(inplanes,inplanes,kernel_size=5, wt_levels=3), #5,3
        ...
        self.conv2 = nn.Sequential(
                WTConv2d(planes,planes,kernel_size=5, wt_levels=3),
...
class ASKCResUNet(nn.Module):
    def __init__(self, in_channels=5, layers=[1,1,1], channels=[8,16,32,64], fuse_mode='AsymBi', tiny=False, classes=1,
