...
parser.add_argument("--dataset_names", default=['MWIRSTD'], type=list, 
                    help="dataset_name: 'NUAA-SIRST', 'NUDT-SIRST', 'IRSTD-1K', 'SIRST3', 'NUDT-SIRST-Sea', 'IRDST-real'")
parser.add_argument("--img_norm_cfg", default=None, type=dict,
                    help="specific a img_norm_cfg, default=None (using img_norm_cfg values of each dataset)")

parser.add_argument("--dataset_dir", default='/home/pengshuang/Public/MWIRSTD/', type=str, help="train_dataset_dir")
...
parser.add_argument("--train_annotation_path", default='train_MWIRSTD.txt', type=str, help="train_dataset_dir")
parser.add_argument("--val_annotation_path", default='test_MWIRSTD.txt', type=str, help="train_dataset_dir")
...
def train():
    ...
    input_shape=[509,655]
    #train_set = seqDataset(dataset_dir,train_annotation_path, input_shape, 5, 'train')
    #single frame
    ...
    if opt.optimizer_name == 'Adam':
        ...
        opt.scheduler_settings = {'epochs':300, 'step': [150, 225], 'gamma': 0.1}
...
def test(save_pth,best_metric):
    ...
    # test_set = seqDatasetval(dataset_dir,val_annotation_path, input_shape, 5, 'val')
