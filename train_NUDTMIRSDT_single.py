...
parser.add_argument("--model_names", default=['SANet'], type=list, 
...
parser.add_argument("--scheduler_settings", default={'step': [50, 75], 'gamma': 0.5}, type=dict, help="scheduler settings")
